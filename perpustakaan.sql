...
('siswa1', '4321', 'Raihan', 'siswa'),
('siswa2', '3333', 'Alie', 'siswa');
...
INSERT INTO buku (judul, pengarang, penerbit, tahun_terbit, isbn, jumlah_stok, kategori_id) VALUES
-- Buku Awal
('Laskar Pelangi', 'Andrea Hirata', 'Bentang Pustaka', 2005, '978-979-1227-00-2', 5, 1),
('Bumi Manusia', 'Pramoedya Ananta Toer', 'Hasta Mitra', 1980, '978-979-9731-28-0', 3, 1),
('Sapiens', 'Yuval Noah Harari', 'Harvill Secker', 2011, '978-0-06-231609-7', 4, 2),
('A Brief History of Time', 'Stephen Hawking', 'Bantam Dell', 1988, '978-0-553-38016-3', 2, 3),
('Sejarah Indonesia Modern', 'M.C. Ricklefs', 'Gadjah Mada University Press', 2005, '978-979-420-480-3', 3, 4),
-- Fiksi
